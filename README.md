...
*Auto-updated daily · Last scan: **2026-08-19** · Found **50+ repos***

### 🏆 Top 10 AI Repos Right Now

| Rank | Repository | Stars | Category | Score |
|------|-----------|-------|----------|-------|
| 1 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 144.5k | `rag` | 100/100 |
| 2 | [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 57.3k | `orchestration` | 100/100 |
| 3 | [HKUDS/nanobot](https://github.com/HKUDS/nanobot) | ⭐ 47.2k | `local-models` | 100/100 |
| 4 | [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 40.0k | `rag` | 100/100 |
| 5 | [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | ⭐ 39.4k | `general` | 100/100 |
| 6 | [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 152.9k | `rag` | 100/100 |
...
**🔍 Rag**
- [**langchain-ai/langchain**](https://github.com/langchain-ai/langchain) ⭐144.5k — The agent engineering platform.
- [**langchain-ai/langgraph**](https://github.com/langchain-ai/langgraph) ⭐40.0k — Build resilient agents.
- [**langgenius/dify**](https://github.com/langgenius/dify) ⭐152.9k — Build Agentic workflows, RAG pipelines, with rich AI model and tool support on o

**⚡ Orchestration**
- [**crewAIInc/crewAI**](https://github.com/crewAIInc/crewAI) ⭐57.3k — Framework for orchestrating role-playing, autonomous AI agents. By fostering col
...
- [**HBAI-Ltd/Toonflow-app**](https://github.com/HBAI-Ltd/Toonflow-app) ⭐14.1k — Toonflow 是开源一站式 AI 短剧创作工具，将小说、剧本快速转化为动画短剧。集成 AI 编剧、智能分镜、角色与视频生成，跨平台桌面端轻量部署，助力创作者
...
- [**holaboss-ai/holaOS**](https://github.com/holaboss-ai/holaOS) ⭐10.0k — Open-source All in One AI agent workspace. Run any agent — Claude Code, Codex — 
...
- [**e2b-dev/awesome-ai-agents**](https://github.com/e2b-dev/awesome-ai-agents) ⭐29.5k — A list of AI autonomous agents
