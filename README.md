...
*Auto-updated daily · Last scan: **2026-08-18** · Found **50+ repos***

### 🏆 Top 10 AI Repos Right Now

| Rank | Repository | Stars | Category | Score |
|------|-----------|-------|----------|-------|
| 1 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 144.4k | `rag` | 100/100 |
| 2 | [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 57.2k | `orchestration` | 100/100 |
| 3 | [HKUDS/nanobot](https://github.com/HKUDS/nanobot) | ⭐ 47.1k | `local-models` | 100/100 |
| 4 | [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 39.9k | `rag` | 100/100 |
| 5 | [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | ⭐ 39.3k | `general` | 100/100 |
| 6 | [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 152.8k | `rag` | 100/100 |
...
**🔍 Rag**
- [**langchain-ai/langchain**](https://github.com/langchain-ai/langchain) ⭐144.4k — The agent engineering platform.
- [**langchain-ai/langgraph**](https://github.com/langchain-ai/langgraph) ⭐39.9k — Build resilient agents.
- [**langgenius/dify**](https://github.com/langgenius/dify) ⭐152.8k — Build Agentic workflows, RAG pipelines, with rich AI model and tool support on o

**⚡ Orchestration**
- [**crewAIInc/crewAI**](https://github.com/crewAIInc/crewAI) ⭐57.2k — Framework for orchestrating role-playing, autonomous AI agents. By fostering col
...
**🤖 General**
- [**AstrBotDevs/AstrBot**](https://github.com/AstrBotDevs/AstrBot) ⭐39.3k — AI Agent Assistant & development framework that integrates lots of IM platforms,
...
- [**holaboss-ai/holaOS**](https://github.com/holaboss-ai/holaOS) ⭐9.5k — Open-source All in One AI agent workspace. Run any agent — Claude Code, Codex — 
...
- [**e2b-dev/E2B**](https://github.com/e2b-dev/E2B) ⭐13.4k — Open-source, secure environment with real-world tools for enterprise-grade agent
