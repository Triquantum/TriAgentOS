...
*Auto-updated daily · Last scan: **2026-07-13** · Found **50+ repos***
...
| 3 | [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 37.2k | `rag` | 100/100 |
| 4 | [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | ⭐ 36.3k | `general` | 100/100 |
| 5 | [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 148.7k | `rag` | 100/100 |
...
| 8 | [jnMetaCode/agency-agents-zh](https://github.com/jnMetaCode/agency-agents-zh) | ⭐ 17.2k | `orchestration` | 100/100 |
| 9 | [rowboatlabs/rowboat](https://github.com/rowboatlabs/rowboat) | ⭐ 16.3k | `orchestration` | 100/100 |
...
- [**langchain-ai/langgraph**](https://github.com/langchain-ai/langgraph) ⭐37.2k — Build resilient agents.
- [**langgenius/dify**](https://github.com/langgenius/dify) ⭐148.7k — Production-ready platform for agentic workflow development.
...
- [**jnMetaCode/agency-agents-zh**](https://github.com/jnMetaCode/agency-agents-zh) ⭐17.2k — 🎭 266 个即插即用的 AI 专家角色 — 支持 Hermes Agent/Claude Code/Cursor/Copilot 等 18 种工具，覆盖工程
- [**rowboatlabs/rowboat**](https://github.com/rowboatlabs/rowboat) ⭐16.3k — Open-source AI coworker, with memory
