...
*Auto-updated daily · Last scan: **2026-07-09** · Found **50+ repos***

### 🏆 Top 10 AI Repos Right Now

| Rank | Repository | Stars | Category | Score |
|------|-----------|-------|----------|-------|
| 1 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 141.4k | `rag` | 100/100 |
| 2 | [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 55.2k | `orchestration` | 100/100 |
| 3 | [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 36.9k | `rag` | 100/100 |
| 4 | [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | ⭐ 36.0k | `general` | 100/100 |
| 5 | [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 148.3k | `rag` | 100/100 |
...
| 8 | [jnMetaCode/agency-agents-zh](https://github.com/jnMetaCode/agency-agents-zh) | ⭐ 16.9k | `orchestration` | 100/100 |
| 9 | [cft0808/edict](https://github.com/cft0808/edict) | ⭐ 16.2k | `security` | 100/100 |
| 10 | [rowboatlabs/rowboat](https://github.com/rowboatlabs/rowboat) | ⭐ 15.8k | `orchestration` | 100/100 |

### 📂 By Category

**🔍 Rag**
- [**langchain-ai/langchain**](https://github.com/langchain-ai/langchain) ⭐141.4k — The agent engineering platform.
- [**langchain-ai/langgraph**](https://github.com/langchain-ai/langgraph) ⭐36.9k — Build resilient agents.
- [**langgenius/dify**](https://github.com/langgenius/dify) ⭐148.3k — Production-ready platform for agentic workflow development.

**⚡ Orchestration**
- [**crewAIInc/crewAI**](https://github.com/crewAIInc/crewAI) ⭐55.2k — Framework for orchestrating role-playing, autonomous AI agents. By fostering col
- [**jnMetaCode/agency-agents-zh**](https://github.com/jnMetaCode/agency-agents-zh) ⭐16.9k — 🎭 266 个即插即用的 AI 专家角色 — 支持 Hermes Agent/Claude Code/Cursor/Copilot 等 18 种工具，覆盖工程
- [**rowboatlabs/rowboat**](https://github.com/rowboatlabs/rowboat) ⭐15.8k — Open-source AI coworker, with memory
...
**💻 Coding**
- [**OthmanAdi/planning-with-files**](https://github.com/OthmanAdi/planning-with-files) ⭐25.1k — Persistent file-based planning for AI coding agents and long-running agentic tas
