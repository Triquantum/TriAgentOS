...
*Auto-updated daily · Last scan: **2026-09-10** · Found **50+ repos***

### 🏆 Top 10 AI Repos Right Now

| Rank | Repository | Stars | Category | Score |
|------|-----------|-------|----------|-------|
| 1 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.1k | `rag` | 100/100 |
| 2 | [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.3k | `orchestration` | 100/100 |
| 3 | [HKUDS/nanobot](https://github.com/HKUDS/nanobot) | ⭐ 48.0k | `local-models` | 100/100 |
| 4 | [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 41.4k | `rag` | 100/100 |
| 5 | [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | ⭐ 40.3k | `general` | 100/100 |
| 6 | [tinyhumansai/openhuman](https://github.com/tinyhumansai/openhuman) | ⭐ 39.6k | `local-models` | 100/100 |
...
| 9 | [jnMetaCode/agency-agents-zh](https://github.com/jnMetaCode/agency-agents-zh) | ⭐ 20.5k | `orchestration` | 100/100 |
| 10 | [rowboatlabs/rowboat](https://github.com/rowboatlabs/rowboat) | ⭐ 17.5k | `orchestration` | 100/100 |

### 📂 By Category

**🔍 Rag**
- [**langchain-ai/langchain**](https://github.com/langchain-ai/langchain) ⭐146.1k — The agent engineering platform.
- [**langchain-ai/langgraph**](https://github.com/langchain-ai/langgraph) ⭐41.4k — Build resilient agents.
...
**⚡ Orchestration**
- [**crewAIInc/crewAI**](https://github.com/crewAIInc/crewAI) ⭐58.3k — Framework for orchestrating role-playing, autonomous AI agents. By fostering col
- [**jnMetaCode/agency-agents-zh**](https://github.com/jnMetaCode/agency-agents-zh) ⭐20.5k — 🎭 277 个即插即用的 AI 专家角色 — 支持 Claude Code/Cursor/Copilot 等 20 种工具，覆盖工程/设计/营销/金融等 20
...
- [**tinyhumansai/openhuman**](https://github.com/tinyhumansai/openhuman) ⭐39.6k — OpenHuman is an open source personal AI for Mac, Windows and Linux — local-first
...
**🤖 General**
- [**AstrBotDevs/AstrBot**](https://github.com/AstrBotDevs/AstrBot) ⭐40.3k — AI Agent Assistant & development framework that integrates lots of IM platforms,
- [**HBAI-Ltd/Toonflow-app**](https://github.com/HBAI-Ltd/Toonflow-app) ⭐15.4k — Toonflow 是开源一站式 AI 短剧创作工具，将小说、剧本快速转化为动画短剧。集成 AI 编剧、智能分镜、角色与视频生成，跨平台桌面端轻量部署，助力创作者
...
- [**vxcontrol/pentagi**](https://github.com/vxcontrol/pentagi) ⭐22.7k — Fully autonomous AI Agents system capable of performing complex penetration test
