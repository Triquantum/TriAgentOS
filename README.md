...
*Auto-updated daily · Last scan: **2026-09-17** · Found **50+ repos***

### 🏆 Top 10 AI Repos Right Now

| Rank | Repository | Stars | Category | Score |
|------|-----------|-------|----------|-------|
| 1 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.5k | `rag` | 100/100 |
| 2 | [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.7k | `orchestration` | 100/100 |
...
| 10 | [rowboatlabs/rowboat](https://github.com/rowboatlabs/rowboat) | ⭐ 17.8k | `orchestration` | 100/100 |

### 📂 By Category

**🔍 Rag**
- [**langchain-ai/langchain**](https://github.com/langchain-ai/langchain) ⭐146.5k — The agent engineering platform.
...
**⚡ Orchestration**
- [**crewAIInc/crewAI**](https://github.com/crewAIInc/crewAI) ⭐58.7k — Framework for orchestrating role-playing, autonomous AI agents. By fostering col
...
- [**rowboatlabs/rowboat**](https://github.com/rowboatlabs/rowboat) ⭐17.8k — Open-source AI coworker, with memory
