...
*Auto-updated daily · Last scan: **2026-07-23** · Found **50+ repos***

### 🏆 Top 10 AI Repos Right Now

| Rank | Repository | Stars | Category | Score |
|------|-----------|-------|----------|-------|
| 1 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 142.4k | `rag` | 100/100 |
| 2 | [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 56.0k | `orchestration` | 100/100 |
| 3 | [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 37.9k | `rag` | 100/100 |
| 4 | [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | ⭐ 37.9k | `general` | 100/100 |
| 5 | [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 149.9k | `rag` | 100/100 |
...
| 8 | [jnMetaCode/agency-agents-zh](https://github.com/jnMetaCode/agency-agents-zh) | ⭐ 18.2k | `orchestration` | 100/100 |
...
**🔍 Rag**
- [**langchain-ai/langchain**](https://github.com/langchain-ai/langchain) ⭐142.4k — The agent engineering platform.
- [**langchain-ai/langgraph**](https://github.com/langchain-ai/langgraph) ⭐37.9k — Build resilient agents.
- [**langgenius/dify**](https://github.com/langgenius/dify) ⭐149.9k — Build Agentic workflows, RAG pipelines, with rich AI model and tool support on o

**⚡ Orchestration**
- [**crewAIInc/crewAI**](https://github.com/crewAIInc/crewAI) ⭐56.0k — Framework for orchestrating role-playing, autonomous AI agents. By fostering col
- [**jnMetaCode/agency-agents-zh**](https://github.com/jnMetaCode/agency-agents-zh) ⭐18.2k — 🎭 267 个即插即用的 AI 专家角色 — 支持 Hermes Agent/Claude Code/Cursor/Copilot 等 18 种工具，覆盖工程
- [**rowboatlabs/rowboat**](https://github.com/rowboatlabs/rowboat) ⭐16.7k — Open-source AI coworker, with memory

**🤖 General**
- [**AstrBotDevs/AstrBot**](https://github.com/AstrBotDevs/AstrBot) ⭐37.9k — AI Agent Assistant & development framework that integrates lots of IM platforms,
- [**HBAI-Ltd/Toonflow-app**](https://github.com/HBAI-Ltd/Toonflow-app) ⭐12.1k — Toonflow 是开源一站式 AI 短剧创作工具，将小说、剧本快速转化为动画短剧。集成 AI 编剧、智能分镜、角色与视频生成，跨平台桌面端轻量部署，助力创作者
