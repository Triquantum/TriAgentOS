...
**💻 Coding**
- [**OthmanAdi/planning-with-files**](https://github.com/OthmanAdi/planning-with-files) ⭐25.2k — Persistent file-based planning for AI coding agents and long-running agentic tas
