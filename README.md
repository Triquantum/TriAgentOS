...
*Auto-updated daily · Last scan: **2026-09-18** · Found **50+ repos***

### 🏆 Top 10 AI Repos Right Now

| Rank | Repository | Stars | Category | Score |
|------|-----------|-------|----------|-------|
| 1 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.6k | `rag` | 100/100 |
...
**🔍 Rag**
- [**langchain-ai/langchain**](https://github.com/langchain-ai/langchain) ⭐146.6k — The agent engineering platform.
...
- [**rowboatlabs/rowboat**](https://github.com/rowboatlabs/rowboat) ⭐17.9k — The multiplayer personal assistant for work
