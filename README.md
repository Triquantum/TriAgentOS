...
*Auto-updated daily · Last scan: **2026-06-01** · Found **50+ repos***

### 🏆 Top 10 AI Repos Right Now

| Rank | Repository | Stars | Category | Score |
|------|-----------|-------|----------|-------|
| 1 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 138.2k | `rag` | 100/100 |
| 2 | [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 52.6k | `orchestration` | 100/100 |
| 3 | [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | ⭐ 33.6k | `general` | 100/100 |
...
| 6 | [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 143.4k | `rag` | 100/100 |
...
**🔍 Rag**
- [**langchain-ai/langchain**](https://github.com/langchain-ai/langchain) ⭐138.2k — The agent engineering platform.
...
**⚡ Orchestration**
- [**crewAIInc/crewAI**](https://github.com/crewAIInc/crewAI) ⭐52.6k — Framework for orchestrating role-playing, autonomous AI agents. By fostering col
...
**🤖 General**
- [**AstrBotDevs/AstrBot**](https://github.com/AstrBotDevs/AstrBot) ⭐33.6k — AI Agent Assistant & development framework that integrates lots of IM platforms,
...
- [**CherryHQ/cherry-studio**](https://github.com/CherryHQ/cherry-studio) ⭐46.7k — AI productivity studio with smart chat, autonomous agents, and 300+ assistants. 
