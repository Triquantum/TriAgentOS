...
*Auto-updated daily · Last scan: **2026-08-17** · Found **50+ repos***
...
| 6 | [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 152.7k | `rag` | 100/100 |
...
- [**langgenius/dify**](https://github.com/langgenius/dify) ⭐152.7k — Build Agentic workflows, RAG pipelines, with rich AI model and tool support on o
...
- [**HBAI-Ltd/Toonflow-app**](https://github.com/HBAI-Ltd/Toonflow-app) ⭐14.0k — Toonflow 是开源一站式 AI 短剧创作工具，将小说、剧本快速转化为动画短剧。集成 AI 编剧、智能分镜、角色与视频生成，跨平台桌面端轻量部署，助力创作者
...
- [**holaboss-ai/holaOS**](https://github.com/holaboss-ai/holaOS) ⭐8.4k — Open-source All in One AI agent workspace. Run any agent — Claude Code, Codex — 
